<section class="content-header">
    <h1>
        Edit Jenis Magang<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Jenis Magang</a></li>
        <li class="active">Edit Jenis Magang</li>
    </ol>
</section>
<section class="content">
  <div class="box box-primary">
    ...
    <div class="row">
      <div class="col-md-8">
        {!! Form::model($jenismagang, array('url' => $uri, 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax') ,'id'=>'simpan')) !!}
        {!! Form::hidden('id') !!}
        <div class="box-body">

    ...
    <div class="box box-primary">
        ...
        <div class="table-responsive">
            <div class="box-body no-padding">
                <table class="table table-striped table-hover table-condensed table-bordered" id='tabel'>
                    ...
                    <tr>
                        <td><center>{!! ClaravelHelpers::ckDelete($supervisor->id); !!}</center></td>
					...
					<td>
                        ...
                        &nbsp;
                        {!! ClaravelHelpers::btnDelete($supervisor->id) !!}
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
        ...
        <div class="box-footer clearfix">
          <div class="row">
            ...
            <div class="col-sm-6">
              <?php echo $supervisors->appends(array('search' => Input::get('search')))->render(); ?>
            </div>
          </div>
        </div>
        {!! Form::close() !!}
